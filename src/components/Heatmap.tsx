    ...
    <div className="flex flex-col gap-4">
      <div ref={containerRef} className="overflow-visible relative">
        ...
        >
          ...
          <span className="text-[#A6A6A6] text-[11px] leading-none">
            {tooltip.dateLabel}
          </span>
      ...
      {/* Legend */}
      <div
        className={`mt-2 flex items-center gap-1 text-[10px] flex-shrink-0 ml-8 ${isLight ? "text-[#A6A6A6]" : "text-[var(--text-muted)]"}`}
      >
        <span>Less</span>
        {levelColors.map((c, i) => (
          <div
